...
// now check to see if it works
        ...
        System.out.println(ecse.printStudentsRegisteredInCourse(2710));

        System.out.println("Students registered in sofe2800: ");
        System.out.println(ecse.printStudentsRegisteredInCourse(2800));

        System.out.println("3D Printing: ");
        System.out.println(amme.printStudentsRegisteredInCourse(2200));

        System.out.println("Students registered in elee4150: ");
        System.out.println(ecse.printStudentsRegisteredInCourse(4150));
